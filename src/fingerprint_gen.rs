...
use super::signature::{DecodedSignature, FrequencyBand, FrequencyPeak};
...
impl FingerprintGenerator {
    ...
    fn do_fft(self: &mut Self, s16_mono_16khz_buffer: &[i16]) {
        ...
        for idx in 0..=2047 {
            self.reordered_ring_buffer_of_samples[idx] = self.ring_buffer_of_samples
                [(idx + self.ring_buffer_of_samples_index) & 2047]
                as f32
                * HANNING_MULTIPLIERS[idx];
        }
